...
Quads mode takes longer than a reduction, with the progress in the result card. For the example models at 10,000 quads it took 5 to 11 seconds, and 3 to 21 seconds for the other test models at 10,000 and 30,000 quads, apart from two torture cases: a restaurant interior of many small parts and a ball of hair strands (in Node on an Apple M5 Pro).
